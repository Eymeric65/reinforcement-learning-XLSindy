...
import matplotlib
matplotlib.use('Qt5Agg')  # Or use 'Qt5Agg' if Tk is unavailable
...
plt.plot(time_values,phase_values[:,0])
plt.plot(time_values,phase_values[:,1])

plt.plot(t_array,state[:,0])
plt.plot(t_array,state[:,1])
plt.show() 
